import { Box, Container, Divider, Grid, Skeleton, useMediaQuery, useTheme } from '@mui/material';
import React from 'react';

const CreateVacancySkeleton = () => {
              ...
              <Grid container spacing={3}>
                <Grid item xs={8}>
                  <Box sx={{ px: 4, bgcolor: "#ffffff", boxShadow: "5px 19px 28px rgba(69, 143, 246, 0.09)", borderRadius: 1, mb: 5 }}>
                    ...
                    <Divider sx={{ my: 2 }} />
                    <Skeleton variant="text" animation="wave" width="300px" height={30} sx={{ mb: 3, mt: 1 }} />
                    <Grid container rowSpacing={3} columnSpacing={8}>
                      <Grid item xs={6}>
                        <Skeleton sx={{ mb: 2, width: "130px" }} />
                        <Skeleton variant="rectangular" sx={{ my: 1, py: 3, borderRadius: 1 }} />
